...
from apps.service_catalog.models import ServiceCategory, Service
...
print(f"  mecanico1 / mec123 (mecánico)")
print(f"  recepcion / rec123 (recepcionista)")
...
# Servicios
Service.objects.create(category=cat_motor, name="Cambio de Aceite", estimated_time_minutes=30, price=350)
Service.objects.create(category=cat_motor, name="Diagnóstico de Motor", estimated_time_minutes=60, price=500)
Service.objects.create(category=cat_frenos, name="Cambio de Balatas", estimated_time_minutes=60, price=800)
Service.objects.create(category=cat_frenos, name="Rectificado de Discos", estimated_time_minutes=90, price=1200)
Service.objects.create(category=cat_suspension, name="Alineación", estimated_time_minutes=45, price=400)
Service.objects.create(category=cat_suspension, name="Balanceo", estimated_time_minutes=30, price=300)
Service.objects.create(category=cat_electrico, name="Diagnóstico Eléctrico", estimated_time_minutes=60, price=600)
Service.objects.create(category=cat_electrico, name="Cambio de Batería", estimated_time_minutes=20, price=150)
Service.objects.create(category=cat_mantenimiento, name="Servicio Completo", estimated_time_minutes=180, price=2500)
Service.objects.create(category=cat_mantenimiento, name="Revisión General", estimated_time_minutes=120, price=1000)
